...
class LaritaDatabase {
    ...
    constructor() {
        try {
            ...
            this.database_connection = new Sequelize('leans_chatbot', "admin", "password", {
                host: "databaseip",
                dialect: "mariadb",
                logging: false,
                sync: true,
            ...
            this.database_connection.authenticate().catch(err => {
                console.log("[ChatBot Database] connection lost");
            });
        } catch (error) {
            console.log("[ChatBot Database] cannot connect to the database: " + error);
        }
    }
    ...
    getUserToken(username) {
        return new Promise(async (resolve, _) => {
            try {
                ...
                console.log("[ChatBot Database] " + username + " crashed get user token: " + error)
                resolve(null);
            }
        });
    }
    ...
    updateUserToken(token, username) {
        return new Promise(async (resolve, _) => {
            try {
                ...
                //Finish
                console.log("[ChatBot Database] " + username + " token updated");
                resolve(false);
            } catch (error) {
                console.log("[ChatBot Database] " + username + " crashed update user token: " + error)
                resolve(true);
            }
        });
    }
    ...
    invalidateUserToken(username) {
        return new Promise(async (resolve, _) => {
            try {
                ...
                //Finish
                console.log("[ChatBot Database]" + username + " token invalidated");
                resolve(false);
            } catch (error) {
                console.log("[ChatBot Database] " + username + " crashed invalidate user token: " + error)
                resolve(true);
            }
        });
    }
    ...
    login(username, password) {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                console.log("[ChatBot Database] " + username + " crashed login: " + error);
                resolve(null);
            }
        });
    }
...
module.exports = new LaritaDatabase;